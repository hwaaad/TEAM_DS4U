...
public class EducationUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String EDUCATION_SQ = multi.getParameter("EDUCATION_SQ");
		...
		if (file != null) {
			...
			EDUCATION_FILE = educationDAO.getFile(EDUCATION_SQ);
			EDUCATION_RFILE = educationDAO.getRealFile(EDUCATION_SQ);
		}
		educationDAO.update(EDUCATION_SQ, EDUCATION_NM, EDUCATION_TXT, EDUCATION_FILE, EDUCATION_RFILE);
