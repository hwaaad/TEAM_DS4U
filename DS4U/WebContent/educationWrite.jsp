	...
	<div id="wsBody">
		<div id="wsBodyContainer">
			...
			<div id="boardInner">
				<div id="inputWrap">
				<div class="container">
					<form method="post" action="./educationWrite" enctype="multipart/form-data">
					<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
						<thead>
							<tr>
								<th colspan="3"><h4>교육자료 작성</h4></th>
							</tr>						
						</thead>
						<tbody>
						<tr>
						...
						<tr>
							...
							<td style="width: 830px;"><textarea id="title" cols="110" maxlength="64" name="EDUCATION_NM" placeholder="글 제목을 입력하세요."></textarea></td>							
						</tr>
						<tr>
							<td style="width: 110px;"><h5>교육자료 내용</h5></td>
							<td style="width: 830px;"><textarea class="form-control" cols="110" rows="10" id="content" name="EDUCATION_TXT" maxlength="255" placeholder="글 내용을 입력하세요."></textarea></td>					
						</tr>
						<tr>
