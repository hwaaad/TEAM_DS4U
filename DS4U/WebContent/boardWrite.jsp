			...
			<div id="boardInner">
				...
				<div class="container">
					...
					<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
						<thead>
							<tr>
								<th style="font-weight: 600; background-color: #EAEAEA !important;" colspan="3"><h4>게시물 작성</h4></th>
							</tr>						
						</thead>
						<tbody>
						<tr>
							<td style="width: 110px; font-weight: 600; background-color: #EAEAEA !important;"><h5>아이디</h5></td>
							<td style="width: 830px; text-align: center;"><h5><%= stf.getSTF_ID() %></h5><input type="hidden" name="STF_ID" value="<%= stf.getSTF_ID() %>"></td>						
						</tr>
						<tr>
