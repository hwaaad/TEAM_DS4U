         ...
         <div id="boardInner">
            ...
            <thead></thead>
               ...
               <tr>
                  ...
                  <td style="width: 1000px; text-align: center;"><h5><%= apv.getAPV_NM() %></h5>
               ...
               <tr>
                  ...
                  <td style="width: 1000px;"><textarea class="form-control" cols="150" name="APV_POLICY_SQ" id="APV_POLICY_SQ" maxlength="30" placeholder="사업방침번호를 입력하세요."><%=apv.getAPV_POLICY_SQ() %></textarea></td>                           
               </tr>
               <tr>
